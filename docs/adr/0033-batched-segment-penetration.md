...
> **ADR-0041 supersession.** The operation and API-6 historical decision below
> remain evidence. Its canonical public owner is now `rayd/penetration.h`,
> aggregated by `rayd/integration.h` at API version 8.
