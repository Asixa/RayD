...
| --- | --- | --- | --- | --- |
| [0001](0001-surfel-remains-drjit-only.md) | Keep surfel support Dr.Jit-only | `F5-surfel-backend-scope` | 2026-07-11 | Superseded by ADR-0042 |
...
| [0037](0037-differentiable-sdf-intersection.md) | Differentiable SDF ray intersection | `differentiable-sdf-intersection` | 2026-07-26 | Accepted; backend-only scope superseded by ADR-0042 |
