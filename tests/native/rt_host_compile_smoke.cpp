...
struct HostTraverser {
    TriangleHit trace_closest(Vec3f, Vec3f, float, float) const { return TriangleHit{0.0f, 0.0f, 0.0f, -1, -1, 0u}; }
    bool trace_occluded(Vec3f, Vec3f, float, float) const { return false; }
    bool trace_occluded_ignore(Vec3f, Vec3f, float, float, const std::int32_t*, int) const { return false; }
    TriangleHit trace_first_blocker(Vec3f, Vec3f, float, float, const std::int32_t*, int) const {
...
using AlgoFn = void (*)(const rayd::shared::optix::ReflectionTraceParams&, std::uint32_t, const HostTraverser&,
                        const HostTraverser&);
...
using HostSegmentConfig = rayd::shared::rt::TraceConfig<HostSegmentLayoutPolicy, HostTraverser>;
using SegmentAlgoFn = void (*)(const rayd::shared::optix::SegmentVisibilityParams&, std::uint32_t,
                               const HostTraverser&);
...
using EpcAlgoFn = void (*)(const rayd::shared::optix::ReflEpcParams&, std::uint32_t, const HostTraverser&,
                           const HostTraverser&);
...
struct HostAccumPolicy {
    ...
    static void commit(const HostAccumParams&, unsigned int, int, int, rayd::shared::field::Complex3, float) {}
};
using ReflAccumAlgoFn = void (*)(const HostAccumParams&, std::uint32_t, const HostTraverser&, const HostTraverser&);
...
using PathAlgoFn = void (*)(const HostPathParams&, std::uint32_t, const HostTraverser&, const HostTraverser&);
...
using HostDiffractionAlgo = rayd::shared::multipath::DiffractionAccumulationAlgo<HostDiffractionPolicy, HostTraverser>;
...
SegmentAlgoFn rt_host_compile_smoke_segment_visibility() {
    ...
    volatile SegmentAlgoFn pair = &rayd::shared::multipath::segment_pair_visibility_algo<HostSegmentConfig>;
    volatile SegmentAlgoFn axial = &rayd::shared::multipath::axial_edge_visibility_algo<HostSegmentConfig>;
    volatile SegmentAlgoFn chain = &rayd::shared::multipath::segment_chain_visibility_algo<HostSegmentConfig>;
    (void)pair;
    (void)axial;
    (void)chain;
...
EpcAlgoFn rt_host_compile_smoke_reflection_epc() {
    ...
    volatile EpcAlgoFn direct = &rayd::shared::multipath::run_reflection_epc_algo<HostEpcConfig, true, false>;
    volatile EpcAlgoFn primary_only = &rayd::shared::multipath::run_reflection_epc_algo<HostEpcConfig, false, true>;
    (void)direct;
    (void)primary_only;
...
ReflAccumAlgoFn rt_host_compile_smoke_reflection_accumulation() {
    return &rayd::shared::multipath::reflection_accumulation_algo<HostAccumParams, HostAccumPolicy, HostTraverser>;
}

PathAlgoFn rt_host_compile_smoke_diffraction_paths() {
    // Exercise the SplitScene axis and both two-phase lanes off-device.
    volatile PathAlgoFn split = &rayd::shared::multipath::trace_paths_order1_algo<HostPathParams, HostTraverser, true>;
...
DfrAccumPmf rt_host_compile_smoke_diffraction_accumulation() {
    ...
    volatile DfrAccumPmf source_vis = &HostDiffractionAlgo::run_diffraction_order1_source_visibility_algo<true>;
    volatile DfrAccumPmf no_suffix =
        &HostDiffractionAlgo::run_diffraction_order1_no_suffix_target_accumulation_algo<true>;
    volatile DfrAccumPmf suffix_first = &HostDiffractionAlgo::run_diffraction_order1_suffix_first_visibility_algo<true>;
    volatile DfrAccumPmf suffix_target =
        &HostDiffractionAlgo::run_diffraction_order1_suffix_target_accumulation_algo<true>;
    volatile DfrAccumPmf coherent = &HostDiffractionAlgo::run_diffraction_order1_coherent_accumulation_algo<true>;
    volatile DfrAccumPmf chain = &HostDiffractionAlgo::run_diffraction_chain_accumulation_algo<false>;
    (void)source_vis;
    (void)no_suffix;
    (void)suffix_first;
    (void)suffix_target;
