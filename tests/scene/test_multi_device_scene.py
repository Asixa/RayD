...
import torch
from tests.scene import test_multi_device_scene as harness
...
loaded = sorted(
    ...
    if name == "rayd._impl.multi" or name.startswith("rayd._impl.multi.")
)
...
class MultiDeviceOptionsExportTests(unittest.TestCase):
    ...
    def test_the_options_dataclass_is_exported_from_the_package(self):
        ...
        from rayd._impl.multi import MultiDeviceOptions as private
...
class CalibrationTests(unittest.TestCase):
    ...
    def test_the_refinement_stage_times_the_dispatch_and_keeps_the_best(self):
        ...
        # from it.
        from rayd._impl.multi import _REFINE_TOLERANCE
...
class AccumulationMixin:
    ...
    def assert_accum_identical(self, left, right, context: str) -> None:
        ...
        from rayd._impl.multi import _DFR_ACCUM_FIELDS
