...
TORCH_ROOT = WORKSPACE_ROOT / "torch"
...
class ProjectMetadataTests(unittest.TestCase):
    ...
    def test_stable_abi_audit_script_is_packaged_with_the_backend(self):
        script = TORCH_ROOT / "scripts" / "verify_stable_abi.py"
    ...
    def test_local_cuda_build_targets_native_gpu(self):
        ...
        dev_build = (TORCH_ROOT / "scripts" / "dev_build_native.ps1").read_text(encoding="utf-8")
        ...
        self.assertTrue((Path(__file__).resolve().parents[2] / "scripts" / "build_local.cmd").is_file())
