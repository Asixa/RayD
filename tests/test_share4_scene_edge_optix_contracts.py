...
SCENE_CONTRACT = ROOT / "include/rayd/shared/scene/optix_contracts.h"
EDGE_CONTRACT = ROOT / "include/rayd/shared/edge/optix_contracts.h"
SBT_CONTRACT = ROOT / "include/rayd/shared/rt/optix_sbt.h"
PIPELINE_CONTRACT = ROOT / "include/rayd/shared/rt/optix_pipeline_contracts.h"
EDGE_DEVICE = ROOT / "include/rayd/shared/edge/optix_device.cuh"
SCENE_DEVICE = ROOT / "include/rayd/shared/scene/optix_device.cuh"
...
class Share4SceneEdgeOptixContractsTests(unittest.TestCase):
    ...
    def test_edge_programs_use_shared_device_helpers(self):
        for path in (DRJIT_EDGE, TORCH_EDGE):
            ...
            self.assertIn("rayd/shared/edge/optix_device.cuh", source)
            for symbol in (
    ...
    def test_backend_specific_edge_outer_params_remain_adapters(self):
        drjit_params = (ROOT / "include/rayd/edge/drjit/edge_optix_params.h").read_text(encoding="utf-8")
    ...
    def test_scene_payload_and_hitobject_order_share_one_contract(self):
        ...
        self.assertIn("rayd/shared/scene/optix_device.cuh", torch_scene)
