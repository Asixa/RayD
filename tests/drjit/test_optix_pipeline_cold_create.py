...
class OptixPipelineColdCreateTests(unittest.TestCase):
    CASES = (
        (
            "intersect",
            "tests.drjit.test_geometry.GeometryCoreTests."
        ...
        (
            "trace_refl_epc",
            "tests.drjit.test_reflection_epc.ReflEpcTests."
        ...
        (
            ...
            "tests.drjit.test_reflection_accumulation.ReflectionAccumulationTests."
            "test_accumulate_reflections_large_cold_launch",
        ),
        (
            "accum_dfr_direct",
            "tests.drjit.test_diffraction_accumulation.DfrAccumulationTests."
