...
class SurfelCloud:
    ...
    value: Array
    surfel_count: int
    def __init__(self, center: Array, tangent_u: Array, tangent_v: Array, opacity: Array, value: Array = ...) -> None: ...
...
class SurfelScene:
    ...
    def composite_alpha_reference(self, ray: Ray | RayAD, active: Mask = ...) -> SurfelComposite | SurfelCompositeAD: ...
    def render(self, ray: Ray | RayAD, render_options: SurfelRenderOptions = ..., active: Mask = ...) -> SurfelRender | SurfelRenderAD: ...
    def update_geometry(self, geometry: SurfelGeometry) -> None: ...
    def update_appearance(self, appearance: SurfelAppearance) -> None: ...

class Mesh:
    def __init__(self, v: Array = ..., f: Array = ..., uv: Array = ..., f_uv: Array = ..., verbose: bool = ...) -> None: ...
    def build(self) -> None: ...
...
class Scene:
    ...
    def _cuda_first_blocker_selftest(self, origin: Array, direction: Array, tmax: Array, ignore: list[int] = ...) -> list[int]: ...
    def trace_reflections(self, ray: Ray | RayAD, max_bounces: int, *args: Any, **kwargs: Any) -> ReflectionTrace | ReflectionTraceAD | ReflectionChain | ReflectionChainAD: ...
    def trace_refl_epc(self, ray: Ray, receiver: Array, max_bounces: int, options: ReflEpcOptions | None = ..., active: Mask = ...) -> ReflEpc: ...
    def trace_refl_epc_field(self, source: Ray | RayAD | Array, receiver: Array, max_bounces: int, options: ReflEpcFieldOptions | ReflEpcFieldOptionsAD, active: Mask = ...) -> ReflEpcField | ReflEpcFieldAD: ...
    def trace_dfr_paths(self, tx_positions: Array, rx_positions: Array, states: DfrStates | DfrStatesAD, material: DfrMaterial | DfrMaterialAD, options: DfrPathOptions = ..., active: Mask = ...) -> DfrPaths | DfrPathsAD: ...
    def accumulate_reflections(self, ray: Ray | RayAD, tx_position: Array, grid: AccumGrid, material: Material | MaterialAD, max_bounces: int, options: AccumOptions = ..., active: Mask = ..., tx_polarization: Array = ...) -> AccumResult | AccumResultAD: ...
    def accum_dfr_direct(self, states: DfrStates | DfrStatesAD, grid: DfrGrid, material: DfrMaterial | DfrMaterialAD, options: DfrOptions = ..., active: Mask = ...) -> DfrAccum | DfrAccumAD: ...
    def accum_dfr(self, initial_states: DfrStates | DfrStatesAD, recursive_states: DfrStates | DfrStatesAD, grid: DfrGrid, material: DfrMaterial | DfrMaterialAD, options: DfrOptions = ..., active: Mask = ...) -> DfrAccum | DfrAccumAD: ...
    def accum_dfr_coherent_direct(self, states: DfrStates | DfrStatesAD, grid: DfrGrid, material: DfrMaterial | DfrMaterialAD, options: DfrCoherentOptions = ..., active: Mask = ...) -> DfrCoherentAccum | DfrCoherentAccumAD: ...
    def build_dfr_coherent_tx_states(self, edges: DfrCoherentEdge | DfrCoherentEdgeAD, tx_position: Array, material: DfrMaterial | DfrMaterialAD, options: DfrCoherentOptions = ..., active: Mask = ...) -> DfrCoherentUtdStates | DfrCoherentUtdStatesAD: ...
    def build_dfr_coherent_higher_candidates(self, prev_states: DfrCoherentUtdStates | DfrCoherentUtdStatesAD, edges: DfrCoherentEdge | DfrCoherentEdgeAD, global_to_local_edge_index: Array, options: DfrCoherentOptions = ..., active: Mask = ...) -> DfrCoherentCandidatePairs | DfrCoherentCandidatePairsAD: ...
    @overload
    ...
    def shadow_test(self, ray: Ray | RayAD, active: Mask = ...) -> Array: ...
    def visible(self, start: Array, end: Array, ignore_prim_ids: Array = ..., active: Mask = ...) -> SegmentVisibility | SegmentVisibilityAD: ...
    def visible_pair(self, start: Array, end_a: Array, end_b: Array, ignore_prim_ids: Array = ..., active: Mask = ...) -> SegmentPairVisibility | SegmentPairVisibilityAD: ...
    def visible_edge(self, src: Array, edge_pos: Array, edge_dir: Array, edge_t_min: Array, edge_t_max: Array, sample_fractions: Sequence[float] = ..., active: Mask = ...) -> AxialEdgeVisibility | AxialEdgeVisibilityAD: ...
    def visible_chain(self, points: Array, chain_length: Array, ignore_prim_per_segment: Array = ..., active: Mask = ...) -> SegmentChainVisibility | SegmentChainVisibilityAD: ...
