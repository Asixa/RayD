...
ScatteringChainEnsembleEvalResult scattering_chain_ensemble_eval(
    ...
    return scattering_chain_ensemble_eval_impl(
        ...
        r.d_i, r.d_o, r.l1, r.l2, r.weights, r.material_id,
...
rayd::torch::ScatteringChainEnsembleEvalBackwardResult scattering_chain_ensemble_eval_backward_impl(
    ...
    return {
        as_optional(g_c1_eps), as_optional(g_c1_sigma),
        as_optional(g_c1_gain), as_optional(g_c1_thick),
        as_optional(g_c2_eps), as_optional(g_c2_sigma),
        as_optional(g_c2_gain), as_optional(g_c2_thick),
        as_optional(g_f_te), as_optional(g_f_tm), as_optional(g_coef),
        as_optional(g_freq)};
}
...
rayd::torch::ScatteringChainEnsembleEvalJvpResult scattering_chain_ensemble_eval_jvp_impl(
    ...
    std::optional<at::Tensor> tangent_v_normal,
...
ScatteringChainEnsembleEvalBackwardResult scattering_chain_ensemble_eval_backward(
    ...
    return scattering_chain_ensemble_eval_backward_impl(
        ...
        r.f_te_flat, r.f_tm_flat, r.table_offset, r.table_dims,
        r.material_slot, r.coefficient, r.threshold, r.frequency_hz,
        q.grad_gain, q.grad_amplitude, q.grad_length,
        q.need_grad_chain1, q.need_grad_chain2, q.need_grad_tables,
        q.need_grad_geometry, q.need_grad_coefficient,
...
ScatteringChainEnsembleEvalJvpResult scattering_chain_ensemble_eval_jvp(
    ...
    return scattering_chain_ensemble_eval_jvp_impl(
        ...
        q.tangent_c1_thickness, q.tangent_c2_eps_r,
        q.tangent_c2_sigma_e, q.tangent_c2_gain, q.tangent_c2_thickness,
        q.tangent_f_te_flat, q.tangent_f_tm_flat, q.tangent_c1_positions,
        q.tangent_c1_normals, q.tangent_c2_positions, q.tangent_c2_normals,
        q.tangent_d_i, q.tangent_d_o, q.tangent_vertex_normal,
        q.tangent_l1, q.tangent_l2, q.tangent_cos_i, q.tangent_cos_o,
        q.tangent_coefficient, q.tangent_frequency);
}
