...
void check_leg_block(
    ...
    rayd::torch::detail::check_scattering_chain_leg(
        positions, normals, eps_r, sigma_e, mu_r, gain, thickness, depth,
        row_count, tag);
}
...
int64_t scattering_chain_realization_check(
    ...
    for (const auto& tref : {
             ...
             tx_pol, rx_pol, l1_rows, l2_rows, sp1_rows, sp2_rows, centroids,
             heights, cos_spec, material_id, layer_offset, layer_count,
...
ScatteringChainRealizationEvalResult scattering_chain_realization_eval(
    ...
    return scattering_chain_realization_eval_impl(
        ...
        r.c2_gain, r.c2_thickness, r.c2_depth,
        r.tx_pol, r.rx_pol, r.l1, r.l2, r.sp1, r.sp2, r.centroids,
        r.heights, r.cos_spec, r.material_id, r.layer_offset, r.layer_count,
        r.layer_thickness_m, r.layer_eps_r, r.layer_sigma_e, r.layer_mu_r,
        r.quad_a, r.quad_b, r.quad_w, r.k0, r.frequency_hz);
}
...
rayd::torch::ScatteringChainRealizationEvalBackwardResult scattering_chain_realization_eval_backward_impl(
    ...
    return {
        opt(need_grad_heights, grad_heights), opt(need_grad_layers, grad_lt),
        ...
        opt(need_grad_geometry, grad_c1_pos),
        opt(need_grad_geometry, grad_c1_nrm),
        opt(need_grad_geometry, grad_c2_pos),
        opt(need_grad_geometry, grad_c2_nrm),
...
rayd::torch::ScatteringChainRealizationEvalJvpResult scattering_chain_realization_eval_jvp_impl(
    ...
    std::optional<at::Tensor> t_layer_thickness, std::optional<at::Tensor> t_layer_eps_r,
    std::optional<at::Tensor> t_layer_sigma_e,
    std::optional<at::Tensor> t_c1_eps_r, std::optional<at::Tensor> t_c1_sigma_e,
    std::optional<at::Tensor> t_c1_gain, std::optional<at::Tensor> t_c1_thickness,
    std::optional<at::Tensor> t_c2_eps_r, std::optional<at::Tensor> t_c2_sigma_e,
    std::optional<at::Tensor> t_c2_gain, std::optional<at::Tensor> t_c2_thickness,
    std::optional<at::Tensor> t_d_i, std::optional<at::Tensor> t_d_o,
    std::optional<at::Tensor> t_c1_positions, std::optional<at::Tensor> t_c1_normals,
    std::optional<at::Tensor> t_c2_positions, std::optional<at::Tensor> t_c2_normals,
    std::optional<at::Tensor> t_l1, std::optional<at::Tensor> t_l2,
    std::optional<at::Tensor> t_sp1, std::optional<at::Tensor> t_sp2,
...
ScatteringChainRealizationEvalBackwardResult scattering_chain_realization_eval_backward(
    ...
    return scattering_chain_realization_eval_backward_impl(
        ...
        r.layer_thickness_m, r.layer_eps_r, r.layer_sigma_e, r.layer_mu_r,
        r.quad_a, r.quad_b, r.quad_w, r.k0, r.frequency_hz,
        q.grad_total, q.grad_path_field, q.grad_path_gain,
        q.need_grad_heights, q.need_grad_layers, q.need_grad_chain1,
        q.need_grad_chain2, q.need_grad_geometry, q.need_grad_k0,
        q.need_grad_frequency);
}
...
ScatteringChainRealizationEvalJvpResult scattering_chain_realization_eval_jvp(
    ...
    return scattering_chain_realization_eval_jvp_impl(
        ...
        r.layer_thickness_m, r.layer_eps_r, r.layer_sigma_e, r.layer_mu_r,
        r.quad_a, r.quad_b, r.quad_w, r.k0, r.frequency_hz,
        q.tangent_heights, q.tangent_layer_thickness, q.tangent_layer_eps_r,
        q.tangent_layer_sigma_e, q.tangent_c1_eps_r,
        q.tangent_c1_sigma_e, q.tangent_c1_gain, q.tangent_c1_thickness,
        q.tangent_c2_eps_r, q.tangent_c2_sigma_e, q.tangent_c2_gain,
        q.tangent_c2_thickness, q.tangent_d_i, q.tangent_d_o,
        q.tangent_c1_positions, q.tangent_c1_normals,
        q.tangent_c2_positions, q.tangent_c2_normals,
        q.tangent_l1, q.tangent_l2, q.tangent_sp1, q.tangent_sp2,
        q.tangent_centroids, q.tangent_k0, q.tangent_frequency);
}
