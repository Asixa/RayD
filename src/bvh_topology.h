...
inline constexpr std::int32_t kBvhTreeletMaxLeaves = ::rayd::shared::BvhTreeletMaxLeaves;
inline constexpr std::int32_t kBvhTreeletMinPrimitives = ::rayd::shared::BvhTreeletMinPrimitives;
...
inline constexpr std::int32_t kBvhTreeletMaxPrimitives = ::rayd::shared::BvhTreeletMaxPrimitives;
inline constexpr std::int32_t kBvhTreeletMinSubtreeLeaves = ::rayd::shared::BvhTreeletMinSubtreeLeaves;
inline constexpr float kBvhTreeletCostInflationRatio = ::rayd::shared::BvhTreeletCostInflationRatio;
inline constexpr std::int32_t kBvhLeafSize = ::rayd::shared::BvhLeafSize;
inline constexpr std::int32_t kBvhTraversalStackDepth = ::rayd::shared::BvhTraversalStackDepth;
inline constexpr std::int32_t kBvhTopKMax = ::rayd::shared::BvhTopKMax;
