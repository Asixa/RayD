...
// Implements bvh support for triangle query shared.

#include <rayd/bvh/triangle_query.h>

#include <rayd/bvh/cuda_bvh_traverser.h>
#include <rayd/bvh/topology.h>
#include <rayd/bvh/triangle_query_device.cuh>

#include <cmath>

// The per-ray traversal cores now live in
// rayd/bvh/triangle_query_device.cuh so the standalone BVH kernels below
