...
std::vector<at::Tensor> visible_pair_forward_impl(std::int64_t scene_handle, at::Tensor start, at::Tensor end_a,
...
/// {any_visible}.
std::vector<at::Tensor> visible_edge_forward_impl(std::int64_t scene_handle, at::Tensor source,
                                                  at::Tensor edge_position, at::Tensor edge_direction,
                                                  at::Tensor edge_t_min, at::Tensor edge_t_max,
...
std::vector<at::Tensor> visible_chain_forward_impl(std::int64_t scene_handle, at::Tensor points,
