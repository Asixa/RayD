...
// Implements diffraction support for paths optix Dr.Jit.
...
#include <rayd/diffraction/paths_optix_device.cuh>
...
// rayd/diffraction/paths_algo.h behind the OptiX shim
// rayd/diffraction/paths_optix_device.cuh; this file only wires the
