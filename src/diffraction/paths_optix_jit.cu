...
// src/diffraction/paths.h; this header keeps only the
...
// src/diffraction/paths.h behind the OptiX shim
// src/diffraction/paths_optix_jit.cu; this file only wires the
