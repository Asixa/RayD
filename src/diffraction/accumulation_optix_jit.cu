...
struct DiffractionAccumulationPolicy {
    static __forceinline__ __device__ const DfrAccumParams& params() { return ::rayd::params; }
    ...
    static __forceinline__ __device__ ::rayd::shared::math::Vec3f state_edge_pos_at(int i) {
        return ::rayd::shared::math::make_vec3(params().state_edge_pos_x[i], params().state_edge_pos_y[i],
                                               params().state_edge_pos_z[i]);
    }

    static __forceinline__ __device__ ::rayd::shared::math::Vec3f state_edge_dir_at(int i) {
        return ::rayd::shared::math::make_vec3(params().state_edge_dir_x[i], params().state_edge_dir_y[i],
...
extern "C" __global__ void __raygen__diffraction_order1_accumulation() {
    Device::run_diffraction_order1_accumulation_raygen<false, false, true, true, true>();
}

extern "C" __global__ void __raygen__diffraction_order1_accumulation_primary() {
    Device::run_diffraction_order1_accumulation_raygen<true, false, true, true, true>();
}

extern "C" __global__ void __raygen__diffraction_order1_accumulation_no_suffix() {
    Device::run_diffraction_order1_accumulation_raygen<false, false, true, true, false>();
}

extern "C" __global__ void __raygen__diffraction_order1_accumulation_no_suffix_primary() {
    Device::run_diffraction_order1_accumulation_raygen<true, false, true, true, false>();
}

extern "C" __global__ void __raygen__diffraction_order1_accumulation_suffix() {
    Device::run_diffraction_order1_accumulation_raygen<false, false, false, false, true>();
}

extern "C" __global__ void __raygen__diffraction_order1_accumulation_suffix_primary() {
    Device::run_diffraction_order1_accumulation_raygen<true, false, false, false, true>();
}
