...
// Declares the Dr.Jit visibility API.
...
template <typename Float_> struct SegmentVisibilityData {
...
template <typename Float_> struct SegmentPairVisibilityData {
    static constexpr bool IsDetached = std::is_same_v<Float_, Float>;
...
template <typename Float_> struct AxialEdgeVisibilityData {
    static constexpr bool IsDetached = std::is_same_v<Float_, Float>;
...
template <typename Float_> struct SegmentChainVisibilityData {
    static constexpr bool IsDetached = std::is_same_v<Float_, Float>;
    ...
    DRJIT_STRUCT(SegmentChainVisibilityData, all_visible, first_blocked_segment, first_blocked_prim)
};
