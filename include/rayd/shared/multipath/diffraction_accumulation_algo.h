...
struct DiffractionAccumulationAlgo {
    ...
    RAYD_HOST_DEVICE static ::rayd::shared::diffraction::float3a to_utd(Vec3f value) {
        return ::rayd::shared::diffraction::make_f3(value.x, value.y, value.z);
    }
    ...
    RAYD_HOST_DEVICE static float first_order_diffraction_parameter(
        ...
        return ::rayd::shared::diffraction::first_order_diffraction_parameter(
            ...
            ::rayd::shared::diffraction::make_f3(edge_origin.x, edge_origin.y, edge_origin.z),
            ::rayd::shared::diffraction::make_f3(edge_dir.x, edge_dir.y, edge_dir.z));
    }
    ...
    RAYD_HOST_DEVICE static ::rayd::shared::diffraction::MaterialParams coherent_material_params() {
        ::rayd::shared::diffraction::MaterialParams mat;
        mat.useFresnel = 0;
        mat.etaR = 0.f;
        mat.muR = 1.f;
        mat.sigma = 0.f;
    ...
    RAYD_HOST_DEVICE static ::rayd::shared::diffraction::PairInputs load_coherent_pair_inputs(int sIdx) {
