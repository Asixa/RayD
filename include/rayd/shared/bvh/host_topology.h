...
inline int compute_subtree_leaf_count(int node_index,
...
inline int compute_subtree_primitive_count(int node_index,
                                           const std::vector<int> &left_child,
                                           const std::vector<int> &right_child,
                                           const std::vector<int> &is_leaf,
...
/// sized to the node count and initialized to -1.
inline int compute_node_height(int node_index,
                               const std::vector<int> &left_child,
                               const std::vector<int> &right_child,
                               const std::vector<int> &is_leaf,
...
inline void collect_subtree_primitives(int node_index,
                                       const std::vector<int> &left_child,
                                       const std::vector<int> &right_child,
...
template <typename Vec3>
int emit_compacted_preorder(int old_node_index,
                            const std::vector<int> &left_child,
                            const std::vector<int> &right_child,
                            const std::vector<int> &leaf_primitive,
                            const std::vector<int> &is_leaf,
                            const std::vector<int> &subtree_leaf_counts,
                            const std::vector<Vec3> &node_bbox_min,
                            const std::vector<Vec3> &node_bbox_max,
                            int leaf_size,
                            HostCompactedBvh<Vec3> &compacted) {
    ...
    const int new_left_child = emit_compacted_preorder(left_child[static_cast<size_t>(old_node_index)],
                                                       left_child,
                                                       right_child,
                                                       leaf_primitive,
                                                       is_leaf,
                                                       ...
                                                       leaf_size,
                                                       compacted);
    const int new_right_child = emit_compacted_preorder(right_child[static_cast<size_t>(old_node_index)],
                                                        left_child,
                                                        right_child,
                                                        leaf_primitive,
                                                        is_leaf,
