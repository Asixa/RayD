...
#include <rayd/shared/optix/optix_traverser.h>

// OptiX entry layer for reflection accumulation. The algorithm body now lives in
// the host-compilable rayd/shared/multipath/reflection_accumulation_algo.h; this
// header keeps only the OptiX-specific pieces: the closesthit / miss programs,
// the six-register payload codec (shared/optix/device_hit.h), and the raygen
