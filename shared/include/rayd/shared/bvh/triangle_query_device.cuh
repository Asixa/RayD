...
// shared/src/bvh/triangle_query.cu so both the standalone traversal kernels (thin
...
__device__ __forceinline__ void traverse_first_blocker(const TriangleSoAView &tri,
                                                       const AabbSoAView &bounds,
                                                       const CompactBvhTopologyView &topology,
                                                       const TriangleTraversalScratchView &scratch,
...
__device__ __forceinline__ void brute_force_closest(const TriangleSoAView &tri,
                                                    float ox, float oy, float oz,
                                                    float dx, float dy, float dz,
                                                    float t_min,
                                                    float &best_t,
...
__device__ __forceinline__ bool brute_force_occluded(const TriangleSoAView &tri,
                                                     float ox, float oy, float oz,
                                                     float dx, float dy, float dz,
                                                     float t_min,
                                                     float t_max) {
