...
rayd::torch::ScatteringTableEvalResult scattering_table_eval_impl(at::Tensor wi, at::Tensor wo, at::Tensor fte, at::Tensor ftm) {
...
at::Tensor scattering_table_pdf_impl(at::Tensor wi, at::Tensor wo, at::Tensor density, bool reverse) {
...
rayd::torch::ScatteringTableSampleResult scattering_table_sample_impl(at::Tensor wi, at::Tensor uniforms, at::Tensor marginal, at::Tensor conditional, at::Tensor density) {
...
rayd::torch::ScatteringTableEvalResult rayd::torch::scattering_table_eval(
    ...
    return scattering_table_eval_impl(
        request.wi, request.wo, request.f_te, request.f_tm);
}
...
rayd::torch::ScatteringTablePdfResult rayd::torch::scattering_table_pdf(
    ...
    return {scattering_table_pdf_impl(
        request.wi, request.wo, request.sample_density, request.reverse)};
}
