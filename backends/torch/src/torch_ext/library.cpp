...
#define RAYDTORCH_SCHEMA_SCENE "__torch__.torch.classes.raydn.Scene"
...
TORCH_LIBRARY_FRAGMENT(raydn, m) {
    m.def("split_scene_vertex_grad(" RAYDTORCH_SCHEMA_SCENE " scene, Tensor grad_vertices) -> Tensor[]");
    m.def("pack_scene_vertex_tangents(" RAYDTORCH_SCHEMA_SCENE " scene, Tensor?[] tangents) -> Tensor?");
    m.def("intersect_forward(" RAYDTORCH_SCHEMA_SCENE " scene, Tensor ray_o, Tensor ray_d, Tensor ray_tmax, Tensor? active) -> Tensor?[]");
    m.def("intersect_forward_flags(" RAYDTORCH_SCHEMA_SCENE " scene, Tensor ray_o, Tensor ray_d, Tensor ray_tmax, Tensor? active, int flags) -> Tensor?[]");
    m.def("intersect_forward_t(" RAYDTORCH_SCHEMA_SCENE " scene, Tensor ray_o, Tensor ray_d, Tensor ray_tmax, Tensor? active) -> Tensor");
    m.def("intersect_forward_ad_flags(" RAYDTORCH_SCHEMA_SCENE " scene, Tensor ray_o, Tensor ray_d, Tensor ray_tmax, Tensor? active, int flags) -> Tensor?[]");
    m.def("intersection_empty_fields(" RAYDTORCH_SCHEMA_SCENE " scene, Tensor like) -> Tensor?[]");
    m.def("intersect_backward_optional(" RAYDTORCH_SCHEMA_SCENE " scene, Tensor ray_o, Tensor ray_d, Tensor ray_tmax, Tensor active, Tensor tape_prim_id, Tensor tape_barycentric, Tensor? grad_t, Tensor? grad_p, Tensor? grad_n, Tensor? grad_geo_n, Tensor? grad_uv, Tensor? grad_barycentric, bool need_grad_vertices, bool need_grad_ray_o, bool need_grad_ray_d, bool need_grad_ray_tmax) -> Tensor?[]");
    m.def("intersect_backward_t(" RAYDTORCH_SCHEMA_SCENE " scene, Tensor ray_o, Tensor ray_d, Tensor active, Tensor tape_prim_id, Tensor tape_barycentric, Tensor grad_t, bool need_grad_vertices, bool need_grad_ray_o, bool need_grad_ray_d, bool need_grad_ray_tmax) -> Tensor?[]");
    m.def("intersect_jvp_optional(" RAYDTORCH_SCHEMA_SCENE " scene, Tensor ray_o, Tensor ray_d, Tensor active, Tensor tape_prim_id, Tensor tape_barycentric, Tensor? tangent_vertices, Tensor? tangent_ray_o, Tensor? tangent_ray_d, int flags) -> Tensor?[]");

    m.def("nearest_edge_forward(" RAYDTORCH_SCHEMA_SCENE " scene, Tensor point) -> Tensor?[]");
    m.def("nearest_edge_forward_noad(" RAYDTORCH_SCHEMA_SCENE " scene, Tensor point) -> Tensor?[]");
    m.def("nearest_edge_ray_forward(" RAYDTORCH_SCHEMA_SCENE " scene, Tensor ray_o, Tensor ray_d, Tensor ray_tmax, Tensor active) -> Tensor?[]");
    m.def("nearest_edge_backward_optional(" RAYDTORCH_SCHEMA_SCENE " scene, Tensor point, Tensor tape_edge_id, Tensor tape_s, Tensor tape_d, Tensor? grad_distance, Tensor? grad_edge_point, Tensor? grad_edge_t, Tensor? grad_edge_t_alias) -> Tensor?[]");
    m.def("nearest_edge_jvp_optional(" RAYDTORCH_SCHEMA_SCENE " scene, Tensor point, Tensor tape_edge_id, Tensor tape_s, Tensor tape_d, Tensor? tangent_vertices, Tensor? tangent_point) -> Tensor?[]");

    m.def("visibility_forward(" RAYDTORCH_SCHEMA_SCENE " scene, Tensor start, Tensor end, Tensor? active) -> Tensor?[]");
    m.def("trace_reflections_forward(" RAYDTORCH_SCHEMA_SCENE " scene, Tensor ray_o, Tensor ray_d, Tensor ray_tmax, Tensor? active, int max_bounces) -> Tensor?[]");
    m.def("trace_reflections_forward_noad(" RAYDTORCH_SCHEMA_SCENE " scene, Tensor ray_o, Tensor ray_d, Tensor ray_tmax, Tensor? active, int max_bounces) -> Tensor?[]");
    m.def("trace_reflections_forward_reduced(" RAYDTORCH_SCHEMA_SCENE " scene, Tensor ray_o, Tensor ray_d, Tensor ray_tmax, Tensor? active, int max_bounces) -> Tensor?[]");
    m.def("trace_reflections_backward_optional(" RAYDTORCH_SCHEMA_SCENE " scene, Tensor ray_o, Tensor ray_d, Tensor ray_tmax, Tensor active, Tensor tape_prim_id, Tensor tape_barycentric, Tensor tape_hit_points, Tensor tape_normals, Tensor image_sources, Tensor? grad_t, Tensor? grad_image_sources) -> Tensor?[]");
    m.def("trace_reflections_jvp_optional(" RAYDTORCH_SCHEMA_SCENE " scene, Tensor ray_o, Tensor ray_d, Tensor active, Tensor tape_prim_id, Tensor tape_barycentric, Tensor tape_hit_points, Tensor tape_normals, Tensor? tangent_vertices, Tensor? tangent_ray_o, Tensor? tangent_ray_d, Tensor image_sources) -> Tensor?[]");
    m.def("trace_refl_epc_field_forward(" RAYDTORCH_SCHEMA_SCENE " scene, Tensor source, Tensor receiver, Tensor? active, int max_bounces) -> Tensor?[]");
    m.def("trace_refl_epc_field_backward(" RAYDTORCH_SCHEMA_SCENE " scene, Tensor source, Tensor receiver, Tensor active, Tensor tape_prim_id, Tensor tape_barycentric, Tensor tape_t, Tensor? grad_field_real, Tensor? grad_field_imag, Tensor? grad_path_length, bool need_grad_vertices, bool need_grad_source, bool need_grad_receiver) -> Tensor?[]");
    m.def("trace_refl_epc_field_jvp(" RAYDTORCH_SCHEMA_SCENE " scene, Tensor source, Tensor receiver, Tensor active, Tensor tape_prim_id, Tensor tape_barycentric, Tensor tape_t, Tensor? tangent_vertices, Tensor? tangent_source, Tensor? tangent_receiver) -> Tensor?[]");
    ...
    m.def("reflection_accumulation_forward(" RAYDTORCH_SCHEMA_SCENE " scene, Tensor ray_o, Tensor ray_d, Tensor ray_tmax, Tensor active, Tensor tx, Tensor tx_pol, int max_bounces, int grid_axis, float grid_position, float grid_coord0_min, float grid_coord0_max, float grid_coord1_min, float grid_coord1_max, int grid_resolution0, int grid_resolution1, float wavelength) -> Tensor?[]");
