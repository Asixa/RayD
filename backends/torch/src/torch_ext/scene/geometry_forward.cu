...
IntersectForwardOutputs intersect_forward_cuda(
    ...
    params.out_shape_id = out.shape_id.data_ptr<int>();
    params.out_local_prim_id = out.local_prim_id.data_ptr<int>();
    params.out_global_prim_id = out.global_prim_id.data_ptr<int>();
